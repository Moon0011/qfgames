...
public class SecondClassifyGvAdapter extends RecyclerView.Adapter {
    ...
    public SecondClassifyGvAdapter(GameClassifyListModel.GameClassify superClassify, List<GameClassifyListModel.GameClassify> datas, String firstClassifyName) {
        this.datas = datas;
...
//                    tempList.add(superClassify);//加上父分类
                    for(GameClassifyListModel.GameClassify data: datas){
                        if(data != null){
                            tempList.add(data);
                        }
                    }
