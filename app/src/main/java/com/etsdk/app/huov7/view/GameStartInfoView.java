...
public class GameStartInfoView extends FrameLayout implements View.OnClickListener {
    ...
    private void initUI() {
        ...
        multiTypeAdapter.register(StartServerInfo2.class, new StartServerInfo2ViewProvider());
        multiTypeAdapter.register(StartServerInfo.class, new StartServerInfoViewProvider());
