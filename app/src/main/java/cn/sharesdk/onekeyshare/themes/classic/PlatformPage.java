...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		initAnims();
		llPanel = (LinearLayout) LayoutInflater.from(activity).inflate(R.layout.activity_share, null);
		activity.setContentView(llPanel);
		llPanel.setAnimation(animShow);
		TextView spaceTop =  (TextView) llPanel.findViewById(R.id.space_top);
		TextView tvShareTitle =  (TextView) llPanel.findViewById(R.id.tv_shareTitle);
		tvShareTitle.setText(ShareUtil.getCurrentShareTitle());
		MobViewPager mobViewPager =  (MobViewPager) llPanel.findViewById(R.id.mobViewPager);
		TextView tvCancelShare =  (TextView) llPanel.findViewById(R.id.tv_cancelShare);
		ArrayList<Object> cells = collectCells();
		PlatformPageAdapter adapter = newAdapter(cells);
		mobViewPager.setAdapter(adapter);
		ViewGroup.LayoutParams layoutParams = mobViewPager.getLayoutParams();
		if(layoutParams==null){
			layoutParams=new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,adapter.getPanelHeight());
		}else{
			layoutParams.height=adapter.getPanelHeight();
		}
		mobViewPager.setLayoutParams(layoutParams);
...
//		llPage.setFitsSystemWindows(true);
...
//
//		LinearLayout.LayoutParams lp2 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,LayoutParams.WRAP_CONTENT);
//		lp2.setMargins(16, 16, 16, 0);
...
//
//		LinearLayout.LayoutParams lp22 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, BaseAppUtil.dip2px(activity,40));
//		lp22.setMargins(45, 16, 45, 16);
//		Button button2 = new Button(activity);
//		button2.setText("取消");
//		button2.setTextSize(16);
//		button2.setTextColor(Color.WHITE);
//		button2.setBackgroundResource(R.drawable.shape_share_circle_rect_blue);
